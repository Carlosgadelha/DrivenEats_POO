...
class Prato {
  ...
  getPratoView() {
    ...
    view.innerHTML = `
          <img src="${this.prato.imagem}" />
          <div class="titulo">${this.prato.nome}</div>
          <div class="descricao">${this.prato.descricao}</div>
          <div class="fundo">
              <div class="preco">R$ ${this.prato.preco.toFixed(2)}</div>
              <div class="check">
